...
export {
	...
	global SMTPurl::run_heuristics: function(link: string, mail_info: mi, c: connection);
	...
	global mail_links_expire_func: function(t: table[string] of mi, link: string): interval ;
       	...
       	global mail_links: table [string] of mi &read_expire=12 hrs &expire_func=mail_links_expire_func  ;
