...
######### ignore links
redef SMTPurl::ignore_fp_links += /proofpoint\.com|GLAKA\.COM|groups\.google\.com\/a\/site\.org\// ;
...
redef SMTPurl::suspicious_text_in_url += /\/auth\/view\/share\/|\/drive\/auth\/share\// ;
