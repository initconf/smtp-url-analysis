...
event log_stats()
{
        log_reporter(fmt("STATS: mail_links: %s, smtp_from: %s, smtp_from_name: %s, smtp_from_email: %s, http_fqdn: %s, email_recv_to_name: %s, email_recv_to_address: %s", |SMTPurl::mail_links|, |SMTPurl::smtp_from|, |SMTPurl::smtp_from_name|, |SMTPurl::smtp_from_email|, |SMTPurl::http_fqdn|, |SMTPurl::email_recv_to_name|, |SMTPurl::email_recv_to_address|),0);
