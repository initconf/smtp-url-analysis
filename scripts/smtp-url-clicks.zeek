...
export {
	...
	global SMTPurl::w_m_url_click: event (link: string, mail_info: mi, c: connection); 
...
event SMTPurl::w_m_url_click(link: string, mail_info: mi, c: connection)
{
	...
	log_reporter(fmt("EVENT: SMTPurl::w_m_url_click: VARS: link: %s, mail_info: %s", link, mail_info),10); 
