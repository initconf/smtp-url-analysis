...
event SMTPurl::m_w_smtpurls_add (link: string, mail_info: mi)
	...
	log_reporter(fmt("EVENT: SMTPurl::m_w_smtpurls_add: link: %s, mail_info: %s", link, mail_info),10); 
	...
	{
               	mail_links[link] = mail_info ;
		log_reporter(fmt("EVENT: SMTPurl::m_w_smtpurls_add: link: %s, mail_links[link]: %s", link, mail_links[link]),0); 
	} 
	}
@endif 
