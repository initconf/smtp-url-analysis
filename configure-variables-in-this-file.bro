...
#########################################################################
### avoid excessive logging of known domains URLs
#########################################################################
...
#########################################################################
### SensitiveURIs 
### signature to alert if there is a string match in the URL 
### example: yoursite.org.fakesite.com  will match on /yoursite\.org/ 
### change site.org below to your domains 
#########################################################################
...
#########################################################################
	redef site_domain: pattern = /site\.gov|es\.net/ &redef ;
        redef site_sub_domains: pattern = /(site\.gov|es\.net)(:[0-9]+|$)/ &redef ;


#########################################################################
### ignore links if matches this string 
#########################################################################
